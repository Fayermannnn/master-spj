...
class TemplateVariableSeeder extends Seeder
{
    public function run(): void
    {
        $variables = [
            ...
            ['key' => 'attendance.personnel_name', 'label' => 'Nama Personel (Absensi)', 'type' => TemplateVariableDataType::Text],
            ['key' => 'attendance.month_name', 'label' => 'Nama Bulan Absensi', 'type' => TemplateVariableDataType::Text],
            ['key' => 'attendance.date', 'label' => 'Tanggal Absensi', 'type' => TemplateVariableDataType::Table],
            ['key' => 'attendance.day_name', 'label' => 'Nama Hari Absensi', 'type' => TemplateVariableDataType::Table],
            ['key' => 'attendance.signature', 'label' => 'Kolom Tanda Tangan Absensi', 'type' => TemplateVariableDataType::Table],
